...
public class AddTripItemActivity extends AppCompatActivity {
    ...
    FirebaseDataHelper firebaseDataHelper = new FirebaseDataHelper(this);
    ...
    public interface OnSaveTripItemListener {
        TripItem getSavedItem(String imagePath);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_saveitem) {
            TripItem enteredTripItem = onSaveTripItemListener.getSavedItem(mCurrentPhotoPath);
