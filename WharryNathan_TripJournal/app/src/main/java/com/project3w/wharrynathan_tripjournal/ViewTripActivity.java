...
public class ViewTripActivity extends AppCompatActivity implements GetTripDetailsHelper.UpdateTripListListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_additem) {
            ...
            // set up our text to share
            String sharedText = getString(R.string.share_trip_message) + currentSelectedTrip;

            // create the intent to allow the user to share to whatever app they want
